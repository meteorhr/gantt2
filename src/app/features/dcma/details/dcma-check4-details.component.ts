...
@Component({
  ...
  <mat-tab-group [mat-stretch-tabs]="false" mat-align-tabs="start" (selectedTabChange)="onTabChange()">
    ...
    @if (row.result?.details?.nonFsList?.length) {
        ...
        <div class="vtable">
          ...
          <cdk-virtual-scroll-viewport class="v-viewport"
            ...
            <table class="vtable__body mat-elevation-z1">
              <tbody>
                <tr *cdkVirtualFor="let x of row.result.details.nonFsList; trackBy: trackNonFs">
...
export class DcmaCheck4DetailsComponent {
  ...
  /** Общее количество элементов во всех массивах внутри details (включая nonFsList и др.). */
