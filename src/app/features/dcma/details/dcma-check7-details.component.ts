        ...
        <div class="vtable">
          ...
          <cdk-virtual-scroll-viewport
            ...
            <table class="vtable__body mat-elevation-z1">
              <tbody>
                <tr *cdkVirtualFor="let i of row.result.details.items; trackBy: trackC7">
...
export class DcmaCheck7DetailsComponent {
